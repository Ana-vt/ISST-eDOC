...
public class Encuesta implements Serializable {
	...
	public byte[] getRespuesta_Texto() {
		return Respuesta_Texto;
	}

	public void setRespuesta_Texto(byte[] respuesta_Texto) {
	...
	public int hashCode() {
		...
		result = prime * result + (int) (temp ^ (temp >>> 32));
		result = prime * result + Arrays.hashCode(Respuesta_Texto);
	...
	public boolean equals(Object obj) {
		...
		if (Double.doubleToLongBits(Respuesta_Test9) != Double.doubleToLongBits(other.Respuesta_Test9))
			return false;
		if (!Arrays.equals(Respuesta_Texto, other.Respuesta_Texto))
			return false;
	...
	public String toString() {
		return "Encuesta [id=" + id + ", Entregada=" + Entregada + ", Asignatura=" + Asignatura + ", fk_Resultado="
				...
				+ ", Respuesta_Test15=" + Respuesta_Test15 + ", Respuesta_Texto=" + Arrays.toString(Respuesta_Texto)
				+ "]";
	}
